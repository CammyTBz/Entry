...
// String or reurns default if no matching key
...
// The readCSV() method splits a value into a sliced based on the comma separator
// If no  matching ky is founfd then return default vlue
